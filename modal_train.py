...
def train():
    ...
    train_dataset = CamelsTXT("train", config.sequence_length, dates=[train_start, train_end], basin_count=config.basin_count)
    ...
    val_dataset = CamelsTXT("eval", config.sequence_length, dates=[val_start, val_end], x_means=x_mean, x_stds=x_std, y_means=y_mean, y_stds=y_std, basin_count=config.basin_count)
